...
def _print_issues(issues, stop_on_error: bool = True) -> None:
    from nodeforge_core.specs.validators import has_errors
...
def validate(
    ...
    from nodeforge.compiler.parser import parse
    from nodeforge_core.specs.validators import has_errors, validate_spec
...
def diff_cmd(
    ...
    from nodeforge.agent_installer import detect_agent
    from nodeforge.runtime.fabric_transport import FabricTransport
    from nodeforge_core.plan.render_diff import render_diff
