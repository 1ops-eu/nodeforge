"""Rich console output for the 'loft-cli plan' command."""
...
from loft_cli_core.plan.models import Plan, StepKind, StepScope
...
def render_plan(plan: Plan, console: Console | None = None) -> None:
    ...
    console.print(
        Panel("\n".join(summary_lines), title="loft-cli plan", border_style="bright_blue")
    )
