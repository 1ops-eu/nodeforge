"""Runtime state management for the loft-cli agent.

Tracks which resources have been applied and their content hashes,
enabling idempotent re-apply (skip unchanged resources).

The state models (RuntimeState, ResourceState) live in loft_cli_core.state
...
from loft_cli_core.agent_paths import AGENT_STATE_FILE
from loft_cli_core.state import ResourceState, RuntimeState
