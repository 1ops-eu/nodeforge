...
server, invokes the nodeforge-agent, and retrieves the results. Falls back
...
from nodeforge.agent.executor import AgentApplyResult
from nodeforge.agent.paths import AGENT_BINARY_PATH, AGENT_DESIRED_DIR
from nodeforge.plan.models import Plan
...
class AgentTransport:
    ...
    def apply_plan(self, plan: Plan) -> AgentApplyResult:
        ...
        result_content = self._ssh.download("/var/lib/nodeforge/last-result.json")
