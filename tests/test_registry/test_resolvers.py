"""Tests for the value resolver registry (loft-cli/registry/resolvers.py)."""

from __future__ import annotations

from loft_cli_core.registry.resolvers import (
    get_resolver,
    list_resolvers,
    register_resolver,
)
...
def _isolated_registry(monkeypatch):
    ...
    monkeypatch.setattr("loft_cli_core.registry.resolvers._RESOLVER_REGISTRY", {})
